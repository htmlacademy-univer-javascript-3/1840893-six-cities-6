...
export const mockOffers: OfferDetails[] = [
  ...
  },
  {
    ...
    rating: 1.8,
    description:
      'Discover daily local life in city center, friendly neighborhood, clandestine casino, karaoke, old-style artisans, digital nomads neighborhood, cats and art in streets.',
    images: [
  ...
  },
  {
    ...
    rating: 2.8,
    description:
      'Peaceful studio in the most wanted area in town. Quiet house Near of everything. Completely renovated.',
    images: [
  ...
  {
    id: '4ccc850a-d32f-4f45-99ed-a23a09138958',
    title: 'Waterfront with extraordinary view',
    type: 'apartment',
    price: 175,
    previewImage: 'https://14.design.htmlacademy.pro/static/hotel/4.jpg',
  ...
  {
    id: '4ccc850a-d32f-4ff5-09ed-a23a09138958',
    title: 'Waterfront with extraordinary view',
    type: 'apartment',
    price: 175,
    previewImage: 'https://14.design.htmlacademy.pro/static/hotel/4.jpg',
